...
BEGIN
	...
	BEGIN TRY
		...
		FROM 'C:\Users\5g\Desktop\DWH Project\sql-data-warehouse-project\datasets\source_crm\cust_info.csv'
		WITH (
			FIRSTROW =2,
			FIELDTERMINATOR = ',',
			TABLOCK
		...
		-----------
		SET @start_time = GETDATE();
		PRINT '>> Truncating Table: bronz.crm_prd_cost';
		TRUNCATE TABLE bronz.crm_prd_cost;

		PRINT '>> Inserting Data Into: bronz.crm_prd_cost';
		BULK INSERT bronz.crm_prd_cost
		FROM 'C:\Users\5g\Desktop\DWH Project\sql-data-warehouse-project\datasets\source_crm\prd_info.csv'
		WITH (
			FIRSTROW =2,
			FIELDTERMINATOR = ',',
			TABLOCK
		...
		FROM 'C:\Users\5g\Desktop\DWH Project\sql-data-warehouse-project\datasets\source_crm\sales_details.csv'
		WITH (
			FIRSTROW =2,
			FIELDTERMINATOR = ',',
			TABLOCK
		...
		FROM 'C:\Users\5g\Desktop\DWH Project\sql-data-warehouse-project\datasets\source_erp\CUST_AZ12.csv'
		WITH (
			FIRSTROW =2,
			FIELDTERMINATOR = ',',
			TABLOCK
		...
		FROM 'C:\Users\5g\Desktop\DWH Project\sql-data-warehouse-project\datasets\source_erp\LOC_A101.csv'
		WITH (
			FIRSTROW =2,
			FIELDTERMINATOR = ',',
			TABLOCK
		...
		FROM 'C:\Users\5g\Desktop\DWH Project\sql-data-warehouse-project\datasets\source_erp\PX_CAT_G1V2.csv'
		WITH (
			FIRSTROW =2,
			FIELDTERMINATOR = ',',
			TABLOCK
		...
		PRINT '======================================================='
		PRINT 'Loading Bronz Layer is Complated'
		PRINT ' - Total Load Duration: ' + CAST(DATEDIFF(second, @batch_start_time, @batch_end_time) AS NVARCHAR) + 'seconds';
		PRINT '======================================================='
    END TRY
	BEGIN CATCH
	PRINT '============================================================='
	PRINT 'ERROR OCCURD DURING LOADING BRONZ LAYER'
